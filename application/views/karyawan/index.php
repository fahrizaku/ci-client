<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <h3>Daftar karyawan Gramedia</h3>
            ...
            <?php endif; ?>
            <ul class="list-group">
                <?php foreach ($karyawan as $mhs) : ?>
                <li class="list-group-item">
                    <?= $mhs['nama']; ?>
                    <a href="<?= base_url(); ?>karyawan/hapus/<?= $mhs['id']; ?>"
                        class="badge badge-danger float-right tombol-hapus">hapus</a>
                    <a href="<?= base_url(); ?>karyawan/ubah/<?= $mhs['id']; ?>"
                        class="badge badge-success float-right">ubah</a>
                    <a href="<?= base_url(); ?>karyawan/detail/<?= $mhs['id']; ?>"
